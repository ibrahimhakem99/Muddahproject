...
namespace Moddah.Controllers
{
    public class NationalitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NationalityID,Name")] Nationality nationality)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NationalityID,Name")] Nationality nationality)
        {
            if (ModelState.IsValid)
            {
